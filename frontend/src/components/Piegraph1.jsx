...
const Piegraph1 = ({graphdata}) => {
  ...
  const options = {
      ...
      tooltip: {
        ...
        callbacks: {
          label: function (tooltipItem) {
            ...
            return ` ${label} Transactions: ${value} (${percentage}%)`; // Dynamic label showing the segment name and value
          },
        },
    ...
    radius: '80%',  //outer radius of piegraph
  };
  return (
    <div className='p-1'>
