...
const DistrictReport = ({tableData, currentTime}) => (
    <Document>
        <Page size="A4" style={styles.page}>
            ...
            <Text style={styles.headerText}>Registered POS District Report</Text>

            <View style={{flexDirection:'row', justifyContent:'space-between'}}>

              <Text style={{ padding: '2', fontSize: '10' }}>
                District :<Text style={{ fontWeight: 'bold' }}>{tableData[0].District}</Text>
              </Text>   
              <Text style={{ padding: '2', fontSize: '10' }}>
            ...
            <View style={styles.table}>
                ...
                <View style={[styles.tableHeaderRow, styles.fixed]} fixed>
                    ...
                    <Text style={styles.tableColHeader}>Block</Text>
                ...
                {tableData.slice(0,tableData.length-1).map((item, index) => (
                    <View style={styles.tableRow} wrap={false} key={item.Block_id}>
                        <Text style={styles.tableCol}>{index+1}</Text>
                       <Text style={styles.tableCol}>{item.Block}</Text>
                ...
                {tableData.slice(-1).map((item) => (
                    <View style={styles.tableRow} key={item.Block_id}>
